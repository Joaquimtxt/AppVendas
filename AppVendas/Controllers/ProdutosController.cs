...
namespace AppVendas.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProdutoId,ProdutoNome,Valor,QtdadeEstoque,CadastroAtivo,CategoriaId")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("ProdutoId,ProdutoNome,Valor,QtdadeEstoque,CadastroAtivo,CategoriaId")] Produto produto)
        {
